...
def welcomepic(pic, user, chat, id, strings):
    background = Image.open("resources/bg1.png")  # <- Background Image (Should be PNG)
    ...
    font = ImageFont.truetype(
        "resources/fonts/Calistoga-Regular.ttf", 37
    ...
    ImageDraw.Draw(background).text(
        ...
        font=ImageFont.truetype("resources/fonts/Calistoga-Regular.ttf", 28),
        size=20,
        align="right",
    )
    background.paste(
